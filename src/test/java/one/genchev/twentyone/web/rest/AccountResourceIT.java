package one.genchev.twentyone.web.rest;

import static one.genchev.twentyone.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;

import java.time.Instant;
import java.util.*;
import one.genchev.twentyone.IntegrationTest;
import one.genchev.twentyone.config.Constants;
import one.genchev.twentyone.domain.User;
import one.genchev.twentyone.repository.AuthorityRepository;
import one.genchev.twentyone.repository.UserRepository;
import one.genchev.twentyone.security.AuthoritiesConstants;
import one.genchev.twentyone.service.UserService;
import one.genchev.twentyone.service.dto.AdminUserDTO;
import one.genchev.twentyone.service.dto.PasswordChangeDTO;
import one.genchev.twentyone.service.dto.UserDTO;
import one.genchev.twentyone.web.rest.vm.KeyAndPasswordVM;
import one.genchev.twentyone.web.rest.vm.ManagedUserVM;
